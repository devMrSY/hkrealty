    ...
    <section id="agents" class="agents section">
      ...
      <div class="container">
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <div class="pic"><img src={agent1} class="img-fluid" alt=""/></div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <div class="pic"><img src={agent2} class="img-fluid" alt=""/></div>
              <div class="member-info">
                <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <div class="pic"><img src={agent3} class="img-fluid" alt=""/></div>
              <div class="member-info">
